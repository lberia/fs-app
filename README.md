...
To run this app you will need either bun or npm installed on your machine. In addition to that, if you don't have docker-compose, you might need other prerequisites on your machine to run this app. It is recommended you use bun runtime for this project, although npm might still work.
